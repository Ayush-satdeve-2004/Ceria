  ...
  return (
    <div className="space-y-16 pb-20">
      ...
      <section className="relative min-h-[550px] w-full overflow-hidden bg-[#0A0617] rounded-b-[40px] flex items-center border-b border-[#c084fc]/15 py-12 lg:py-20">
        ...
        {loading ? (
          /* Glowing Skeleton Banner Loader */
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 w-full relative z-10 animate-pulse">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-4 space-y-6 text-center lg:text-left min-h-[300px] flex flex-col justify-center">
                <div className="h-6 w-40 bg-[#8B3DFF]/15 border border-[#8B3DFF]/30 rounded-full mx-auto lg:mx-0"></div>
                <div className="space-y-3">
                  <div className="h-10 sm:h-12 w-full bg-[#140B2D] border border-[#c084fc]/10 rounded-2xl"></div>
                  <div className="h-10 sm:h-12 w-4/5 bg-[#140B2D] border border-[#c084fc]/10 rounded-2xl mx-auto lg:mx-0"></div>
                </div>
                <div className="space-y-2">
                  <div className="h-4 w-full bg-[#140B2D] border border-[#c084fc]/5 rounded-lg"></div>
                  <div className="h-4 w-5/6 bg-[#140B2D] border border-[#c084fc]/5 rounded-lg mx-auto lg:mx-0"></div>
                </div>
                <div className="h-12 w-36 bg-[#140B2D] border border-[#c084fc]/15 rounded-xl mx-auto lg:mx-0 pt-2"></div>
              </div>
              {/* Right Column Skeleton */}
              <div className="lg:col-span-8 relative flex justify-center min-h-[350px] items-center w-full">
                <div className="w-full max-w-[750px] aspect-[16/9] rounded-3xl bg-[#140B2D] border border-[#c084fc]/15 flex items-center justify-center relative overflow-hidden">
                  <div className="w-16 h-16 rounded-full bg-[#8B3DFF]/10 flex items-center justify-center">
                    <Sparkles className="w-8 h-8 text-[#C084FC]/30 animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
